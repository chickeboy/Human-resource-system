...
<body>
		...
		<div class="nano">
			<div class="nano-content">
				<ul>
					...
					<li><a id="resume" class="sidebar-sub-toggle"><i
							class="ti-layout"></i> 简 历 <span
							class="sidebar-collapse-icon ti-angle-down"></span></a>
						<ul>
							<li id="addresume"><a>添加简历</a></li>
						</ul></li>
						<li><a id="recruit" class="sidebar-sub-toggle"><i
							class="ti-package"></i>招   聘  <span
							class="sidebar-collapse-icon ti-angle-down"></span></a>
						<ul>
							<li id="myinterview"><a>我的招聘</a></li>
						</ul></li>										
				</ul>
			</div>
		</div>
	...
	<!-- scripit init-->
	<script type="text/javascript" src="js/indextourists.js"></script>
</body>
</html>
