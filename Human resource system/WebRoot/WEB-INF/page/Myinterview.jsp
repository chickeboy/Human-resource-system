...
<script>
	$(".agree").click(function() {
		...
		$.ajax({
			type : "POST",
			url : "addEmploy.action",
			data : {
				name : $(this).parent().find('td').eq(1).html(),
				birthday : $(this).parent().find('td').eq(2).html(),
				department : $(this).parent().find('td').eq(6).html(),
				position : $(this).parent().find('td').eq(7).html()
			},
